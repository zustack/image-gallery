      ...
      <div>
        ...
        <p className="text-center text-foreground/80 pt-[50px] text-xl">
          ...
          <span className="block">
            It demonstrates how to upload images to the Zustack network and
            display them efficiently in a web application.
          </span>
          <span className="block">
        ...
        <div className="flex justify-center gap-4 pt-[50px]">
          <Button
            onClick={() => {
              window.open("https://github.com/zustack/image-gallery", "_blank");
            }}
          >
            View Source Code
            <svg
